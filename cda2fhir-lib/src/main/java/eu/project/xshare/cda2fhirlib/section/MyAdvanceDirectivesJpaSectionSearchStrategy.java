...
public class MyAdvanceDirectivesJpaSectionSearchStrategy extends JpaSectionSearchStrategy<Consent> {
  ...
  public boolean shouldInclude(
      @NotNull IpsSectionContext<Consent> theIpsSectionContext, @NotNull Consent theCandidate) {
    if (theCandidate.getStatus() == Consent.ConsentState.ACTIVE) {
      return true;
    }
