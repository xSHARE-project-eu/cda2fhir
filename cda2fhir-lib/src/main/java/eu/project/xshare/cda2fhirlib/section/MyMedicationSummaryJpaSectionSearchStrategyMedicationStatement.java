...
public class MyMedicationSummaryJpaSectionSearchStrategyMedicationStatement
  ...
  public boolean shouldInclude(
      @NotNull IpsSectionContext<MedicationStatement> theIpsSectionContext,
      @NotNull MedicationStatement theCandidate) {
    if (theCandidate.getStatus() == MedicationStatement.MedicationStatementStatus.ACTIVE
        || theCandidate.getStatus() == MedicationStatement.MedicationStatementStatus.INTENDED
        || theCandidate.getStatus() == MedicationStatement.MedicationStatementStatus.UNKNOWN
        || theCandidate.getStatus() == MedicationStatement.MedicationStatementStatus.ONHOLD) {
      return true;
    }
