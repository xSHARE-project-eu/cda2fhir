...
public class MyDiagnosticResultsJpaSectionSearchStrategyObservation
  ...
  public boolean shouldInclude(
    ...
    if (theCandidate.getStatus() == Observation.ObservationStatus.CANCELLED
        ...
        || !isLaboratoryObservation(theCandidate)) {
      return false;
    }
  ...
  private boolean isLaboratoryObservation(Observation observation) {
