...
public class MyMedicationSummaryJpaSectionSearchStrategyMedicationAdministration
  ...
  public boolean shouldInclude(
      @NotNull IpsSectionContext<MedicationAdministration> theIpsSectionContext,
      @NotNull MedicationAdministration theCandidate) {
    if (theCandidate.getStatus()
            == MedicationAdministration.MedicationAdministrationStatus.INPROGRESS
        || theCandidate.getStatus()
